-- Little Lovely Pets data pipeline schema.
-- Existing Supabase state has public."Pet" from Prisma already; this migration
-- extends that table instead of creating a duplicate lowercase pets table.
